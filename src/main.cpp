...
void test1()
{
    ...
    mergeSettings.outFile = "/home/bing/code/EcadOpt/test";
    ...
    EThermalSimulationSetup simulationSetup;
    simulationSetup.simuType = EThermalSimuType::Static;
    simulationSetup.environmentTemperature = 25;
    simulationSetup.workDir = "/home/bing/code/EcadOpt/test";
    auto model = layout->ExtractThermalModel(prismaSettings);

    auto maxT = layout->RunThermalSimulation(prismaSettings, simulationSetup);
    std::cout << maxT << std::endl;//wbtest
